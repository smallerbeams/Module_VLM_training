...
class Chat:
    ...
    def answer_prepare(self, conv, img_list, max_new_tokens=300, num_beams=1, min_length=1, top_p=0.9,
        ...
        # print("用於輸入Llama的影像文字embedding: ", embs.shape)
        current_max_len = embs.shape[1] + max_new_tokens
        # print("輸入的token長度: ",current_max_len, "最大支援:", max_new_tokens)
        if current_max_len - max_length > 0:
            print('Warning: The number of tokens in current conversation exceeds the max length. '
                  'The model will not see the contexts outside the range.')
        begin_idx = max(0, current_max_len - max_length)
        embs = embs[:, begin_idx:]
        # print("stopping_criteria", self.stopping_criteria)
    ...
    def stream_answer(self, conv, img_list, **kargs):
        ...
        # print("stream_answer: ", generation_kwargs)
    ...
    def model_generate(self, *args, **kwargs):
        ...
        # print("Model!!!!!!!!!!!")
        # print(self.model)
        # print(self.model.maybe_autocast())
